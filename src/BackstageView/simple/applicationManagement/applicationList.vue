        ...
        <el-col>
          ...
          <div class="table-control">
            <el-table size="small" class="table-style" :data="projects" border highlight-current-row @current-change="handleCurrentChange">
              ...
              <el-table-column align="left" clalss="setCenter" prop="auditorOne" label="审核员1" min-width="80"  resizable show-overflow-tooltip></el-table-column>
              <el-table-column align="left" clalss="setCenter" prop="auditorTwo" label="审核员2" min-width="80"  resizable show-overflow-tooltip></el-table-column>
