        ...
        <el-col>
          ...
          <div class="table-control">
            <el-table size="small" class="table-style" :data="projects" border highlight-current-row @current-change="handleCurrentChange">
              <el-table-column show-overflow-tooltip align="left" prop="projectName" label="项目名称" min-width="100" fixed="left" sortable resizable show-overflow-tooltip>
                <template slot-scope="scope">
                  <p v-on:click="displayPermission(projects[scope.$index].projectId)"
                     style="text-decoration: underline">
                    {{ projects[scope.$index].projectName }}
                  </p>
                </template>
              </el-table-column>
              ...
              <el-table-column align="left" clalss="setCenter" prop="state" label="状态" min-width="80" sortable resizable show-overflow-tooltip></el-table-column>
